Recom_Generation <- function(training_file, classfile, outcome_name, nL, nR, prior.positive = 1e-4, Nrec, itr = 500, Nlib, maxL, maxR, minL, minR, Gamma_0 = 1000, Gamma_1 =
...
#################################################################################################################################################################################
ROC_plot <- function(prob_file,Y, out_file) 
{
#================================================================================================================================================================================
#Function: ROC_plot
#
...
#Input Arguments
#	prob_file
#		The name(including the full path) of the file containing a vector of predicted probability. Each line of this file is a number which is the probability of a
#		pepide being hit.
#	Y
