...
% peptides.
a=csvread('forplot_2.csv',1,1); 
h=figure;
hold;
plot(1:100,a(1,:),'r');
plot(1:100,a(2,:),'g')
plot(1:100,a(3,:),'b')
xlabel('No. of recommendations','FontSize',20);
ylabel('P(shortest hit <= 12)','FontSize',20);
axis([0 100 0 1.2]);
legend('Probability of Improvment','Ranking estimated probability of hit','mutation');
...
print(h,'-dpng','maxP_comparison.pdf');
